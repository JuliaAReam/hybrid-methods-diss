...
if __name__ == "__main__":
    ...
    for case in cases:
        if case == "same":
            t1 = "plt67808_slice_0000_aQoI.npz"
            t2 = "plt70526_slice_0000_aQoI.npz"
            t3 = "plt73243_slice_0000_aQoI.npz"
            t4 = "plt75358_slice_0000_aQoI.npz"
            times = [t1, t2, t3, t4] 
        elif case == "314":
            t1 = "plt77018_slice_0000_aQoI.npz"
            t2 = "plt79877_slice_0000_aQoI.npz"
            t3 = "plt82743_slice_0000_aQoI.npz"
            t4 = "plt85091_slice_0000_aQoI.npz"
            times =	[t1, t2, t3, t4]
        elif case == "350":
            t1 = "plt67788_slice_0000_aQoI.npz"
            t2 = "plt70508_slice_0000_aQoI.npz"
            t3 = "plt73229_slice_0000_aQoI.npz"
            t4 = "plt75344_slice_0000_aQoI.npz"
            times =	[t1, t2, t3, t4]
    ...
    for case in cases:
        ...
        for QoI in QoIs:
            ...
            fnameA = os.path.join(fdir, case+"_ambient/vertical_slices/Additional_QoI", all_times[case][0])
            fnameB = os.path.join(fdir, case+"_ambient/vertical_slices/Additional_QoI", all_times[case][1])
            fnameC = os.path.join(fdir, case+"_ambient/vertical_slices/Additional_QoI", all_times[case][2])
            fnameD = os.path.join(fdir, case+"_ambient/vertical_slices/Additional_QoI", all_times[case][3])
            ...
            if (QoI == "E" or QoI == "Hi"):
                ...
                QoI1_scaled = (QoI1 - QoI_ambient)/(QoI_inflow - QoI_ambient)
                QoI2_scaled = (QoI2 - QoI_ambient)/(QoI_inflow - QoI_ambient)
                QoI3_scaled = (QoI3 - QoI_ambient)/(QoI_inflow - QoI_ambient)
                QoI4_scaled = (QoI4 - QoI_ambient)/(QoI_inflow - QoI_ambient)
    ...
    for QOI in QoIs:
        ...
        fnameA = os.path.join(fdir, "314_ambient/vertical_slices/Additional_QoI", all_times["314"][3])
        fnameB = os.path.join(fdir, "350_ambient/vertical_slices/Additional_QoI", all_times["350"][3])
        fnameC = os.path.join(fdir, "same_ambient/vertical_slices/Additional_QoI", all_times["same"][3])
        ...
        if (QOI == "E" or QOI == "Hi"):
            ...
            # center314 = center314*1e-7
            # center350 = center350*1e-7
    ...
    for QOI in QoIs:
        ...
        fnameA = os.path.join(fdir, "314_ambient/vertical_slices/Additional_QoI/avg_vertical.npz")
        fnameB = os.path.join(fdir, "350_ambient/vertical_slices/Additional_QoI/avg_vertical.npz")
        fnameC = os.path.join(fdir, "same_ambient/vertical_slices/Additional_QoI/avg_vertical.npz")
        ...
        print("same ambient is: ", ambient330)
        print("314 ambient is: ", ambient314)
        print("350 ambient is: ", ambient350)
        print()
        ...
        plt.savefig(
            os.path.join(odir, QOI+"_vert_avg.pdf"), format="pdf", dpi=300
        )
        plt.close("all")
        ...
        plt.savefig(
            os.path.join(odir, QOI+"_scaled_vert_avg.pdf"), format="pdf", dpi=300
        )
        plt.close("all")
