...
\end{equation}
Monotonicity is enforced with van Leer limiting \cite{}, with limited values denoted $\delta q_i^*$. Using these limited values, primitive variables can then be interpolated to cell edges:
\begin{equation}
