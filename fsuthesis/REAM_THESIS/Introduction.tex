...
{\bf Matt's shit to edit - put in intro somewhere actually}
The meyer et al. case is similar to what we consider; however, their work involves a phase-change whereas our cases remain supercritical throughout the duration of the simulations. When you're that close to the critical point, there's no hard-cutoff between where something goes from a liquid to a supercritical fluid. The psuedocritical region remains an ongoing research question that we investigate here. 
...
%
%\subsection{Density and Temperature and Pressure, Oh My!}
%
